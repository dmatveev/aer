...
(defun position-in-seazon (date)
  (let ((seazon (seazon-of date))
        (month (date-month date)))
    (cond ((eql seazon 'winter) (mod month 12))
          ((eql seazon 'spring) (- month 3))
          ((eql seazon 'summer) (- month 6))
          ((eql seazon 'autumn) (- month 9)))))
